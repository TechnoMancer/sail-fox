...
output/foxmulator.c: model/prelude.sail model/types.sail model/registers.sail model/instructions/begin.sail model/instructions/branch.sail model/instructions/short_immediate.sail model/instructions/system.sail model/instructions/end.sail model/main.sail
	$(SAIL) -c -o output/foxmulator -c_no_main model/prelude.sail model/types.sail model/registers.sail model/instructions/begin.sail model/instructions/branch.sail model/instructions/short_immediate.sail model/instructions/system.sail model/instructions/end.sail model/main.sail
clean:
	rm -rf output